...
*CourseEnrollmentApi* | [**courseEnrollmentStudentGotCourseFrom**](docs/Api/CourseEnrollmentApi.md#courseenrollmentstudentgotcoursefrom) | **GET** /CourseEnrollments/{id}/studentGotCourseFrom | Get the customer who bought a course for a user.
