...
class FromWooCommerceApi
{
     ...
     * @throws \Yoast\MyYoastApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Yoast\MyYoastApiClient\Model\ProductOffering
     */
     ...
     * @throws \Yoast\MyYoastApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Yoast\MyYoastApiClient\Model\ProductOffering, HTTP status code, HTTP response headers (array of strings)
     */
    public function productFromWooCommerceWithHttpInfo($body)
    {
        $returnType = '\Yoast\MyYoastApiClient\Model\ProductOffering';
