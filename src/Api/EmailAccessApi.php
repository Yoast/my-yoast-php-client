...
/**
 * EmailAccessApi Class Doc Comment
 *
 * @category Class
 * @package  Yoast\MyYoastApiClient
 * @author   Swagger Codegen team
...
class EmailAccessApi
{
     ...
     * @return \Yoast\MyYoastApiClient\Model\EmailAccess[]
     */
     ...
     * @throws \Yoast\MyYoastApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Yoast\MyYoastApiClient\Model\EmailAccess[], HTTP status code, HTTP response headers (array of strings)
     */
    public function getManyWithHttpInfo($filter = null)
    {
        $returnType = '\Yoast\MyYoastApiClient\Model\EmailAccess[]';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Yoast\MyYoastApiClient\Model\EmailAccess[]',
    ...
    protected function getManyPagedRequest($filter = null)
    {
        ...
        $resourcePath = '/api/EmailAccess/paged';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
