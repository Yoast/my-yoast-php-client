...
class ProductApi
{
     ...
     */
    public function apiProductsBulkPost($bulkDto)
    {
        list($response) = $this->apiProductsBulkPostWithHttpInfo($bulkDto);
        return $response;
    }
     ...
     */
    public function apiProductsBulkPostWithHttpInfo($bulkDto)
    {
        $returnType = '\Yoast\MyYoastApiClient\Model\Product[]';
        $request = $this->apiProductsBulkPostRequest($bulkDto);
     ...
     */
    public function apiProductsBulkPostAsync($bulkDto)
    {
        return $this->apiProductsBulkPostAsyncWithHttpInfo($bulkDto)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiProductsBulkPostAsyncWithHttpInfo($bulkDto)
    {
        $returnType = '\Yoast\MyYoastApiClient\Model\Product[]';
        $request = $this->apiProductsBulkPostRequest($bulkDto);
     ...
     */
    protected function apiProductsBulkPostRequest($bulkDto)
    {
        // verify the required parameter 'bulkDto' is set
        if ($bulkDto === null || (is_array($bulkDto) && count($bulkDto) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $bulkDto when calling apiProductsBulkPost'
            );
        }
     ...
     * @return \Yoast\MyYoastApiClient\Model\Product
     */
    public function apiProductsIdPatch($product, $id)
    {
        list($response) = $this->apiProductsIdPatchWithHttpInfo($product, $id);
        return $response;
    }
     ...
     * @return array of \Yoast\MyYoastApiClient\Model\Product, HTTP status code, HTTP response headers (array of strings)
     */
    public function apiProductsIdPatchWithHttpInfo($product, $id)
    {
        $returnType = '\Yoast\MyYoastApiClient\Model\Product';
        $request = $this->apiProductsIdPatchRequest($product, $id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiProductsIdPatchAsync($product, $id)
    {
        return $this->apiProductsIdPatchAsyncWithHttpInfo($product, $id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiProductsIdPatchAsyncWithHttpInfo($product, $id)
    {
        $returnType = '\Yoast\MyYoastApiClient\Model\Product';
        $request = $this->apiProductsIdPatchRequest($product, $id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function apiProductsIdPatchRequest($product, $id)
    {
        // verify the required parameter 'product' is set
        if ($product === null || (is_array($product) && count($product) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $product when calling apiProductsIdPatch'
            );
        }
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
    ...
    {
        list($response) = $this->apiProductsPostWithHttpInfo($product);
        return $response;
    }
