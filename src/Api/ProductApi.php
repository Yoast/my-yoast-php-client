...
class ProductApi
{
     ...
     * @return void
     */
    public function apiProductsWordpressPluginVersionDetailsGet($password = null)
    {
        $this->apiProductsWordpressPluginVersionDetailsGetWithHttpInfo($password);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function apiProductsWordpressPluginVersionDetailsGetWithHttpInfo($password = null)
    {
        $returnType = '';
        $request = $this->apiProductsWordpressPluginVersionDetailsGetRequest($password);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiProductsWordpressPluginVersionDetailsGetAsync($password = null)
    {
        return $this->apiProductsWordpressPluginVersionDetailsGetAsyncWithHttpInfo($password)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiProductsWordpressPluginVersionDetailsGetAsyncWithHttpInfo($password = null)
    {
        $returnType = '';
        $request = $this->apiProductsWordpressPluginVersionDetailsGetRequest($password);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function apiProductsWordpressPluginVersionDetailsGetRequest($password = null)
    {
