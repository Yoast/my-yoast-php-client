...
class CustomerApi
{
     ...
     */
    public function customerTransfer($from_source_id, $to_source_id)
    {
        list($response) = $this->customerTransferWithHttpInfo($from_source_id, $to_source_id);
        return $response;
    }

    /**
     * Operation customerTransferWithHttpInfo
     *
     * @param double $from_source_id  (required)
     * @param double $to_source_id  (required)
     * @throws \Yoast\MyYoastApiClient\ApiException on non-2xx response
     ...
     */
    public function customerTransferWithHttpInfo($from_source_id, $to_source_id)
    {
        // verify the required parameter 'from_source_id' is set
        if ($from_source_id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $from_source_id when calling customerTransfer');
        }
        // verify the required parameter 'to_source_id' is set
        if ($to_source_id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $to_source_id when calling customerTransfer');
        }
        // parse inputs
        $resourcePath = "/Customers/transfer";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
