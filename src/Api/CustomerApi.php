...
class CustomerApi
{
    ...
    /**
     * Operation customerGetAllRoles
     *
     * Retrieves all existing roles from the db, matched to their ids.
     *
     * @throws \Yoast\MyYoastApiClient\ApiException on non-2xx response
     * @return \Yoast\MyYoastApiClient\Model\XAny[]
     */
    public function customerGetAllRoles()
    {
        list($response) = $this->customerGetAllRolesWithHttpInfo();
        return $response;
    }

    /**
     * Operation customerGetAllRolesWithHttpInfo
     *
     * Retrieves all existing roles from the db, matched to their ids.
     *
     * @throws \Yoast\MyYoastApiClient\ApiException on non-2xx response
     * @return array of \Yoast\MyYoastApiClient\Model\XAny[], HTTP status code, HTTP response headers (array of strings)
     */
    public function customerGetAllRolesWithHttpInfo()
    {
        // parse inputs
        $resourcePath = "/Customers/allroles";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Yoast\MyYoastApiClient\Model\XAny[]',
                '/Customers/allroles'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Yoast\MyYoastApiClient\Model\XAny[]', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Yoast\MyYoastApiClient\Model\XAny[]', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
    ...
    /**
     * Operation customerGetCustomersWithRole
     *
     ...
     * @return \Yoast\MyYoastApiClient\Model\XAny[]
     */
    public function customerGetCustomersWithRole()
    {
        list($response) = $this->customerGetCustomersWithRoleWithHttpInfo();
        return $response;
    }

    /**
     * Operation customerGetCustomersWithRoleWithHttpInfo
     *
     * Retrieves all the customer ids from the RoleMapping table.
     *
     * @throws \Yoast\MyYoastApiClient\ApiException on non-2xx response
     * @return array of \Yoast\MyYoastApiClient\Model\XAny[], HTTP status code, HTTP response headers (array of strings)
     */
    public function customerGetCustomersWithRoleWithHttpInfo()
    {
        // parse inputs
        $resourcePath = "/Customers/rolemapping-ids";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
    ...
    /**
     * Operation customerPrototypeCountRoleMapping
     *
     ...
     * @return \Yoast\MyYoastApiClient\Model\InlineResponse200
     */
    public function customerPrototypeCountRoleMapping($id, $where = null)
    {
        list($response) = $this->customerPrototypeCountRoleMappingWithHttpInfo($id, $where);
        return $response;
    }

    /**
     * Operation customerPrototypeCountRoleMappingWithHttpInfo
     *
     * Counts roleMapping of Customer.
     *
     * @param string $id Customer id (required)
     ...
     * @return array of \Yoast\MyYoastApiClient\Model\InlineResponse200, HTTP status code, HTTP response headers (array of strings)
     */
    public function customerPrototypeCountRoleMappingWithHttpInfo($id, $where = null)
    {
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling customerPrototypeCountRoleMapping');
        }
        // parse inputs
        $resourcePath = "/Customers/{id}/roleMapping/count";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $headerParams,
                '\Yoast\MyYoastApiClient\Model\InlineResponse200',
                '/Customers/{id}/roleMapping/count'
            );
    ...
    /**
     * Operation customerPrototypeCreateRoleMapping
     *
     ...
     */
    public function customerPrototypeCreateRoleMapping($id, $data = null)
    {
        list($response) = $this->customerPrototypeCreateRoleMappingWithHttpInfo($id, $data);
        return $response;
    }

    /**
     * Operation customerPrototypeCreateRoleMappingWithHttpInfo
     *
     * Creates a new instance in roleMapping of this model.
     *
     * @param string $id Customer id (required)
     ...
     */
    public function customerPrototypeCreateRoleMappingWithHttpInfo($id, $data = null)
    {
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling customerPrototypeCreateRoleMapping');
        }
        // parse inputs
        $resourcePath = "/Customers/{id}/roleMapping";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
    ...
    /**
     * Operation customerPrototypeDeleteRoleMapping
     *
     ...
     * @return void
     */
    public function customerPrototypeDeleteRoleMapping($id)
    {
        list($response) = $this->customerPrototypeDeleteRoleMappingWithHttpInfo($id);
        return $response;
    }

    /**
     * Operation customerPrototypeDeleteRoleMappingWithHttpInfo
     *
     * Deletes all roleMapping of this model.
     *
     * @param string $id Customer id (required)
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function customerPrototypeDeleteRoleMappingWithHttpInfo($id)
    {
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling customerPrototypeDeleteRoleMapping');
        }
        // parse inputs
        $resourcePath = "/Customers/{id}/roleMapping";
        $httpBody = '';
    ...
    /**
     * Operation customerPrototypeDestroyByIdRoleMapping
     *
     * Delete a related item by id for roleMapping.
     *
     * @param string $id Customer id (required)
     * @param string $fk Foreign key for roleMapping (required)
     * @throws \Yoast\MyYoastApiClient\ApiException on non-2xx response
     * @return void
     */
    public function customerPrototypeDestroyByIdRoleMapping($id, $fk)
    {
        list($response) = $this->customerPrototypeDestroyByIdRoleMappingWithHttpInfo($id, $fk);
        return $response;
    }

    /**
     * Operation customerPrototypeDestroyByIdRoleMappingWithHttpInfo
     *
     * Delete a related item by id for roleMapping.
     *
     * @param string $id Customer id (required)
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function customerPrototypeDestroyByIdRoleMappingWithHttpInfo($id, $fk)
    {
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling customerPrototypeDestroyByIdRoleMapping');
        }
        // verify the required parameter 'fk' is set
        if ($fk === null) {
            throw new \InvalidArgumentException('Missing the required parameter $fk when calling customerPrototypeDestroyByIdRoleMapping');
        }
        // parse inputs
        $resourcePath = "/Customers/{id}/roleMapping/{fk}";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
    ...
    /**
     * Operation customerPrototypeFindByIdRoleMapping
     *
     ...
     * @return \Yoast\MyYoastApiClient\Model\RoleMapping
     */
    public function customerPrototypeFindByIdRoleMapping($id, $fk)
    {
        list($response) = $this->customerPrototypeFindByIdRoleMappingWithHttpInfo($id, $fk);
        return $response;
    }

    /**
     * Operation customerPrototypeFindByIdRoleMappingWithHttpInfo
     *
     * Find a related item by id for roleMapping.
     *
     * @param string $id Customer id (required)
     ...
     * @return array of \Yoast\MyYoastApiClient\Model\RoleMapping, HTTP status code, HTTP response headers (array of strings)
     */
    public function customerPrototypeFindByIdRoleMappingWithHttpInfo($id, $fk)
    {
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling customerPrototypeFindByIdRoleMapping');
        }
        // verify the required parameter 'fk' is set
        if ($fk === null) {
            throw new \InvalidArgumentException('Missing the required parameter $fk when calling customerPrototypeFindByIdRoleMapping');
        }
        // parse inputs
        $resourcePath = "/Customers/{id}/roleMapping/{fk}";
        $httpBody = '';
    ...
    /**
     * Operation customerPrototypeGetRoleMapping
     *
     ...
     * @return \Yoast\MyYoastApiClient\Model\RoleMapping[]
     */
    public function customerPrototypeGetRoleMapping($id, $filter = null)
    {
        list($response) = $this->customerPrototypeGetRoleMappingWithHttpInfo($id, $filter);
        return $response;
    }

    /**
     * Operation customerPrototypeGetRoleMappingWithHttpInfo
     *
     * Queries roleMapping of Customer.
     *
     * @param string $id Customer id (required)
     ...
     * @return array of \Yoast\MyYoastApiClient\Model\RoleMapping[], HTTP status code, HTTP response headers (array of strings)
     */
    public function customerPrototypeGetRoleMappingWithHttpInfo($id, $filter = null)
    {
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling customerPrototypeGetRoleMapping');
        }
        // parse inputs
        $resourcePath = "/Customers/{id}/roleMapping";
        $httpBody = '';
    ...
    /**
     * Operation customerPrototypeUpdateByIdRoleMapping
     *
     ...
     * @return \Yoast\MyYoastApiClient\Model\RoleMapping
     */
    public function customerPrototypeUpdateByIdRoleMapping($id, $fk, $data = null)
    {
        list($response) = $this->customerPrototypeUpdateByIdRoleMappingWithHttpInfo($id, $fk, $data);
        return $response;
    }

    /**
     * Operation customerPrototypeUpdateByIdRoleMappingWithHttpInfo
     *
     * Update a related item by id for roleMapping.
     *
     * @param string $id Customer id (required)
     ...
     * @return array of \Yoast\MyYoastApiClient\Model\RoleMapping, HTTP status code, HTTP response headers (array of strings)
     */
    public function customerPrototypeUpdateByIdRoleMappingWithHttpInfo($id, $fk, $data = null)
    {
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling customerPrototypeUpdateByIdRoleMapping');
        }
        // verify the required parameter 'fk' is set
        if ($fk === null) {
            throw new \InvalidArgumentException('Missing the required parameter $fk when calling customerPrototypeUpdateByIdRoleMapping');
        }
        // parse inputs
        $resourcePath = "/Customers/{id}/roleMapping/{fk}";
        $httpBody = '';
