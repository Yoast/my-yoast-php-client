...
class EDDApi
{
    ...
    protected function eddSlApiGetRequest($eddAction, $url, $itemName)
    {
        ...
        // query params
        if ($eddAction !== null) {
            $queryParams['edd_action'] = ObjectSerializer::toQueryValue($eddAction);
        }
        // query params
        if ($url !== null) {
        ...
        // query params
        if ($itemName !== null) {
            $queryParams['item_name'] = ObjectSerializer::toQueryValue($itemName);
        }
     ...
     *
     * @param  \Yoast\MyYoastApiClient\Model\EddDTO $eddDTO eddDTO (required)
     * @param  string $eddAction eddAction (required)
     *
     * @throws \Yoast\MyYoastApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     */
    public function eddSlApiPost($eddDTO, $eddAction)
    {
        $this->eddSlApiPostWithHttpInfo($eddDTO, $eddAction);
    }

    /**
     * Operation eddSlApiPostWithHttpInfo
     *
     * @param  \Yoast\MyYoastApiClient\Model\EddDTO $eddDTO (required)
     * @param  string $eddAction (required)
     *
     * @throws \Yoast\MyYoastApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function eddSlApiPostWithHttpInfo($eddDTO, $eddAction)
    {
        $returnType = '';
        $request = $this->eddSlApiPostRequest($eddDTO, $eddAction);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function eddSlApiPostAsync($eddDTO, $eddAction)
    {
        return $this->eddSlApiPostAsyncWithHttpInfo($eddDTO, $eddAction)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function eddSlApiPostAsyncWithHttpInfo($eddDTO, $eddAction)
    {
        $returnType = '';
        $request = $this->eddSlApiPostRequest($eddDTO, $eddAction);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function eddSlApiPostRequest($eddDTO, $eddAction)
    {
        // verify the required parameter 'eddDTO' is set
        if ($eddDTO === null || (is_array($eddDTO) && count($eddDTO) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $eddDTO when calling eddSlApiPost'
            );
        }
        // verify the required parameter 'eddAction' is set
        if ($eddAction === null || (is_array($eddAction) && count($eddAction) === 0)) {
