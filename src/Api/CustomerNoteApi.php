...
class CustomerNoteApi
{
     ...
     */
    public function apiCustomerNotesBulkPost($bulkDto)
    {
        list($response) = $this->apiCustomerNotesBulkPostWithHttpInfo($bulkDto);
        return $response;
    }
     ...
     */
    public function apiCustomerNotesBulkPostWithHttpInfo($bulkDto)
    {
        $returnType = '\Yoast\MyYoastApiClient\Model\CustomerNote[]';
        $request = $this->apiCustomerNotesBulkPostRequest($bulkDto);
     ...
     */
    public function apiCustomerNotesBulkPostAsync($bulkDto)
    {
        return $this->apiCustomerNotesBulkPostAsyncWithHttpInfo($bulkDto)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiCustomerNotesBulkPostAsyncWithHttpInfo($bulkDto)
    {
        $returnType = '\Yoast\MyYoastApiClient\Model\CustomerNote[]';
        $request = $this->apiCustomerNotesBulkPostRequest($bulkDto);
     ...
     */
    protected function apiCustomerNotesBulkPostRequest($bulkDto)
    {
        // verify the required parameter 'bulkDto' is set
        if ($bulkDto === null || (is_array($bulkDto) && count($bulkDto) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $bulkDto when calling apiCustomerNotesBulkPost'
            );
        }
     ...
     *
     * @param  \Yoast\MyYoastApiClient\Model\CustomerNote $customerNote customerNote (required)
     * @param  float $id id (required)
     *
     * @throws \Yoast\MyYoastApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Yoast\MyYoastApiClient\Model\CustomerNote
     */
    public function apiCustomerNotesIdPatch($customerNote, $id)
    {
        list($response) = $this->apiCustomerNotesIdPatchWithHttpInfo($customerNote, $id);
        return $response;
    }
     ...
     * Update one CustomerNote
     *
     * @param  \Yoast\MyYoastApiClient\Model\CustomerNote $customerNote (required)
     * @param  float $id (required)
     *
     * @throws \Yoast\MyYoastApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Yoast\MyYoastApiClient\Model\CustomerNote, HTTP status code, HTTP response headers (array of strings)
     */
    public function apiCustomerNotesIdPatchWithHttpInfo($customerNote, $id)
    {
        $returnType = '\Yoast\MyYoastApiClient\Model\CustomerNote';
        $request = $this->apiCustomerNotesIdPatchRequest($customerNote, $id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiCustomerNotesIdPatchAsync($customerNote, $id)
    {
        return $this->apiCustomerNotesIdPatchAsyncWithHttpInfo($customerNote, $id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiCustomerNotesIdPatchAsyncWithHttpInfo($customerNote, $id)
    {
        $returnType = '\Yoast\MyYoastApiClient\Model\CustomerNote';
        $request = $this->apiCustomerNotesIdPatchRequest($customerNote, $id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function apiCustomerNotesIdPatchRequest($customerNote, $id)
    {
        // verify the required parameter 'customerNote' is set
        if ($customerNote === null || (is_array($customerNote) && count($customerNote) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $customerNote when calling apiCustomerNotesIdPatch'
            );
        }
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
     ...
     * @return \Yoast\MyYoastApiClient\Model\CustomerNote
     */
    public function apiCustomerNotesPost($customerNote)
    {
        list($response) = $this->apiCustomerNotesPostWithHttpInfo($customerNote);
        return $response;
    }
     ...
     * @return array of \Yoast\MyYoastApiClient\Model\CustomerNote, HTTP status code, HTTP response headers (array of strings)
     */
    public function apiCustomerNotesPostWithHttpInfo($customerNote)
    {
        $returnType = '\Yoast\MyYoastApiClient\Model\CustomerNote';
        $request = $this->apiCustomerNotesPostRequest($customerNote);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiCustomerNotesPostAsync($customerNote)
    {
        return $this->apiCustomerNotesPostAsyncWithHttpInfo($customerNote)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiCustomerNotesPostAsyncWithHttpInfo($customerNote)
    {
        $returnType = '\Yoast\MyYoastApiClient\Model\CustomerNote';
        $request = $this->apiCustomerNotesPostRequest($customerNote);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function apiCustomerNotesPostRequest($customerNote)
    {
        // verify the required parameter 'customerNote' is set
        if ($customerNote === null || (is_array($customerNote) && count($customerNote) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $customerNote when calling apiCustomerNotesPost'
            );
        }
