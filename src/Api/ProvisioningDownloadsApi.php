...
class ProvisioningDownloadsApi
{
     ...
     * @throws \Yoast\MyYoastApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Yoast\MyYoastApiClient\Model\ProductVersionsDto
     */
    public function currentVersionV2($productCode)
    {
        list($response) = $this->currentVersionV2WithHttpInfo($productCode);
        return $response;
    }

    /**
     * Operation currentVersionV2WithHttpInfo
     *
     * Get current version of downloads for a product.
     *
     * @param  string $productCode The code used to create the product. (required)
     ...
     * @throws \Yoast\MyYoastApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Yoast\MyYoastApiClient\Model\ProductVersionsDto, HTTP status code, HTTP response headers (array of strings)
     */
    public function currentVersionV2WithHttpInfo($productCode)
    {
        $returnType = '\Yoast\MyYoastApiClient\Model\ProductVersionsDto';
        $request = $this->currentVersionV2Request($productCode);
    ...
    /**
     * Operation currentVersionV2Async
     *
     * Get current version of downloads for a product.
     *
     * @param  string $productCode The code used to create the product. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function currentVersionV2Async($productCode)
    {
        return $this->currentVersionV2AsyncWithHttpInfo($productCode)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation currentVersionV2AsyncWithHttpInfo
     *
     * Get current version of downloads for a product.
     *
     * @param  string $productCode The code used to create the product. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function currentVersionV2AsyncWithHttpInfo($productCode)
    {
        $returnType = '\Yoast\MyYoastApiClient\Model\ProductVersionsDto';
        $request = $this->currentVersionV2Request($productCode);
    ...
    /**
     * Create request for operation 'currentVersionV2'
     *
     * @param  string $productCode The code used to create the product. (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function currentVersionV2Request($productCode)
    {
        // verify the required parameter 'productCode' is set
        if ($productCode === null || (is_array($productCode) && count($productCode) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $productCode when calling currentVersionV2'
            );
        }

        $resourcePath = '/api/v2/provisioning/downloads/currentVersion';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
