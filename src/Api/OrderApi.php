...
class OrderApi
{
     ...
     */
    public function getDownloads($invoiceNumber)
    {
        list($response) = $this->getDownloadsWithHttpInfo($invoiceNumber);
        return $response;
    }
     ...
     */
    public function getDownloadsWithHttpInfo($invoiceNumber)
    {
        $returnType = '\Yoast\MyYoastApiClient\Model\DownloadDto[]';
        $request = $this->getDownloadsRequest($invoiceNumber);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getDownloadsAsync($invoiceNumber)
    {
        return $this->getDownloadsAsyncWithHttpInfo($invoiceNumber)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getDownloadsAsyncWithHttpInfo($invoiceNumber)
    {
        $returnType = '\Yoast\MyYoastApiClient\Model\DownloadDto[]';
        $request = $this->getDownloadsRequest($invoiceNumber);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getDownloadsRequest($invoiceNumber)
    {
        // verify the required parameter 'invoiceNumber' is set
        if ($invoiceNumber === null || (is_array($invoiceNumber) && count($invoiceNumber) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $invoiceNumber when calling getDownloads'
            );
        }

        $resourcePath = '/api/Orders/{invoiceNumber}/downloads';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
