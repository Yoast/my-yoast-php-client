...
class SubscriptionApi
{
     ...
     */
    public function apiSubscriptionsBulkPost($bulkDto)
    {
        list($response) = $this->apiSubscriptionsBulkPostWithHttpInfo($bulkDto);
        return $response;
    }
     ...
     */
    public function apiSubscriptionsBulkPostWithHttpInfo($bulkDto)
    {
        $returnType = '\Yoast\MyYoastApiClient\Model\Subscription[]';
        $request = $this->apiSubscriptionsBulkPostRequest($bulkDto);
     ...
     */
    public function apiSubscriptionsBulkPostAsync($bulkDto)
    {
        return $this->apiSubscriptionsBulkPostAsyncWithHttpInfo($bulkDto)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiSubscriptionsBulkPostAsyncWithHttpInfo($bulkDto)
    {
        $returnType = '\Yoast\MyYoastApiClient\Model\Subscription[]';
        $request = $this->apiSubscriptionsBulkPostRequest($bulkDto);
     ...
     */
    protected function apiSubscriptionsBulkPostRequest($bulkDto)
    {
        // verify the required parameter 'bulkDto' is set
        if ($bulkDto === null || (is_array($bulkDto) && count($bulkDto) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $bulkDto when calling apiSubscriptionsBulkPost'
            );
        }
     ...
     *
     * @param  \Yoast\MyYoastApiClient\Model\Subscription $subscription subscription (required)
     * @param  string $id id (required)
     *
     * @throws \Yoast\MyYoastApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Yoast\MyYoastApiClient\Model\Subscription
     */
    public function apiSubscriptionsIdPatch($subscription, $id)
    {
        list($response) = $this->apiSubscriptionsIdPatchWithHttpInfo($subscription, $id);
        return $response;
    }
     ...
     * Update one Subscription
     *
     * @param  \Yoast\MyYoastApiClient\Model\Subscription $subscription (required)
     * @param  string $id (required)
     *
     * @throws \Yoast\MyYoastApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Yoast\MyYoastApiClient\Model\Subscription, HTTP status code, HTTP response headers (array of strings)
     */
    public function apiSubscriptionsIdPatchWithHttpInfo($subscription, $id)
    {
        $returnType = '\Yoast\MyYoastApiClient\Model\Subscription';
        $request = $this->apiSubscriptionsIdPatchRequest($subscription, $id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiSubscriptionsIdPatchAsync($subscription, $id)
    {
        return $this->apiSubscriptionsIdPatchAsyncWithHttpInfo($subscription, $id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiSubscriptionsIdPatchAsyncWithHttpInfo($subscription, $id)
    {
        $returnType = '\Yoast\MyYoastApiClient\Model\Subscription';
        $request = $this->apiSubscriptionsIdPatchRequest($subscription, $id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function apiSubscriptionsIdPatchRequest($subscription, $id)
    {
     ...
     * @return \Yoast\MyYoastApiClient\Model\Subscription
     */
    public function apiSubscriptionsPost($subscription)
    {
        list($response) = $this->apiSubscriptionsPostWithHttpInfo($subscription);
        return $response;
    }
     ...
     * @return array of \Yoast\MyYoastApiClient\Model\Subscription, HTTP status code, HTTP response headers (array of strings)
     */
    public function apiSubscriptionsPostWithHttpInfo($subscription)
    {
        $returnType = '\Yoast\MyYoastApiClient\Model\Subscription';
        $request = $this->apiSubscriptionsPostRequest($subscription);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiSubscriptionsPostAsync($subscription)
    {
        return $this->apiSubscriptionsPostAsyncWithHttpInfo($subscription)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiSubscriptionsPostAsyncWithHttpInfo($subscription)
    {
        $returnType = '\Yoast\MyYoastApiClient\Model\Subscription';
        $request = $this->apiSubscriptionsPostRequest($subscription);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function apiSubscriptionsPostRequest($subscription)
    {
        // verify the required parameter 'subscription' is set
        if ($subscription === null || (is_array($subscription) && count($subscription) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $subscription when calling apiSubscriptionsPost'
            );
        }
