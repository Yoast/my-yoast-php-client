...
class SubscriptionApi
{
     ...
     * Set Date.
     *
     * @param  \Yoast\MyYoastApiClient\Model\SetExpiryDateDto $setExpiryDateDto setExpiryDateDto (required)
     *
     * @throws \Yoast\MyYoastApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Yoast\MyYoastApiClient\Model\Subscription
     */
    public function apiSubscriptionsSetExpiryDatePost($setExpiryDateDto)
    {
        list($response) = $this->apiSubscriptionsSetExpiryDatePostWithHttpInfo($setExpiryDateDto);
        return $response;
    }
     ...
     * Set Date.
     *
     * @param  \Yoast\MyYoastApiClient\Model\SetExpiryDateDto $setExpiryDateDto (required)
     *
     * @throws \Yoast\MyYoastApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Yoast\MyYoastApiClient\Model\Subscription, HTTP status code, HTTP response headers (array of strings)
     */
    public function apiSubscriptionsSetExpiryDatePostWithHttpInfo($setExpiryDateDto)
    {
        $returnType = '\Yoast\MyYoastApiClient\Model\Subscription';
        $request = $this->apiSubscriptionsSetExpiryDatePostRequest($setExpiryDateDto);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiSubscriptionsSetExpiryDatePostAsync($setExpiryDateDto)
    {
        return $this->apiSubscriptionsSetExpiryDatePostAsyncWithHttpInfo($setExpiryDateDto)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiSubscriptionsSetExpiryDatePostAsyncWithHttpInfo($setExpiryDateDto)
    {
        $returnType = '\Yoast\MyYoastApiClient\Model\Subscription';
        $request = $this->apiSubscriptionsSetExpiryDatePostRequest($setExpiryDateDto);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function apiSubscriptionsSetExpiryDatePostRequest($setExpiryDateDto)
    {
        // verify the required parameter 'setExpiryDateDto' is set
        if ($setExpiryDateDto === null || (is_array($setExpiryDateDto) && count($setExpiryDateDto) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $setExpiryDateDto when calling apiSubscriptionsSetExpiryDatePost'
            );
        }
        ...
        // body params
        $_tempBody = null;
        if (isset($setExpiryDateDto)) {
            $_tempBody = $setExpiryDateDto;
        }
     ...
     *
     * @param  \Yoast\MyYoastApiClient\Model\TransferOwnershipDto $transferOwnershipDto transferOwnershipDto (required)
     *
     * @throws \Yoast\MyYoastApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Yoast\MyYoastApiClient\Model\Subscription[]
     */
    public function apiSubscriptionsTransferPost($transferOwnershipDto)
    {
        list($response) = $this->apiSubscriptionsTransferPostWithHttpInfo($transferOwnershipDto);
        return $response;
    }
     ...
     * Transfer subscription ownership
     *
     * @param  \Yoast\MyYoastApiClient\Model\TransferOwnershipDto $transferOwnershipDto (required)
     *
     * @throws \Yoast\MyYoastApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Yoast\MyYoastApiClient\Model\Subscription[], HTTP status code, HTTP response headers (array of strings)
     */
    public function apiSubscriptionsTransferPostWithHttpInfo($transferOwnershipDto)
    {
        $returnType = '\Yoast\MyYoastApiClient\Model\Subscription[]';
        $request = $this->apiSubscriptionsTransferPostRequest($transferOwnershipDto);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiSubscriptionsTransferPostAsync($transferOwnershipDto)
    {
        return $this->apiSubscriptionsTransferPostAsyncWithHttpInfo($transferOwnershipDto)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiSubscriptionsTransferPostAsyncWithHttpInfo($transferOwnershipDto)
    {
        $returnType = '\Yoast\MyYoastApiClient\Model\Subscription[]';
        $request = $this->apiSubscriptionsTransferPostRequest($transferOwnershipDto);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function apiSubscriptionsTransferPostRequest($transferOwnershipDto)
    {
        // verify the required parameter 'transferOwnershipDto' is set
        if ($transferOwnershipDto === null || (is_array($transferOwnershipDto) && count($transferOwnershipDto) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $transferOwnershipDto when calling apiSubscriptionsTransferPost'
            );
        }
        ...
        // body params
        $_tempBody = null;
        if (isset($transferOwnershipDto)) {
            $_tempBody = $transferOwnershipDto;
        }
