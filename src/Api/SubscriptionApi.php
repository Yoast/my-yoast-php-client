...
class SubscriptionApi
{
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function runScriptWithHttpInfo()
    {
        $returnType = '';
        $request = $this->runScriptRequest();
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function runScriptAsync()
    {
        return $this->runScriptAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function runScriptAsyncWithHttpInfo()
    {
        $returnType = '';
        $request = $this->runScriptRequest();
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function runScriptRequest()
    {

        $resourcePath = '/api/Subscriptions/runscript';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
