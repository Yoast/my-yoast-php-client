...
class SubscriptionApi
{
    ...
    /**
     * Operation subscriptionRecalculateSubscriptionCount
     *
     * @param string $id  (required)
     * @throws \Yoast\MyYoastApiClient\ApiException on non-2xx response
     * @return \Yoast\MyYoastApiClient\Model\Subscription
     */
    public function subscriptionRecalculateSubscriptionCount($id)
    {
        list($response) = $this->subscriptionRecalculateSubscriptionCountWithHttpInfo($id);
        return $response;
    }

    /**
     * Operation subscriptionRecalculateSubscriptionCountWithHttpInfo
     *
     * @param string $id  (required)
     * @throws \Yoast\MyYoastApiClient\ApiException on non-2xx response
     * @return array of \Yoast\MyYoastApiClient\Model\Subscription, HTTP status code, HTTP response headers (array of strings)
     */
    public function subscriptionRecalculateSubscriptionCountWithHttpInfo($id)
    {
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling subscriptionRecalculateSubscriptionCount');
        }
        // parse inputs
        $resourcePath = "/Subscriptions/{id}/recalculateSubscriptionCount";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $headerParams,
                '\Yoast\MyYoastApiClient\Model\Subscription',
                '/Subscriptions/{id}/recalculateSubscriptionCount'
            );
