...
class SiteApi
{
     ...
     * @return object
     */
    public function apiSitesInfoGet($token, $url)
    {
     ...
     * @return array of object, HTTP status code, HTTP response headers (array of strings)
     */
    public function apiSitesInfoGetWithHttpInfo($token, $url)
    {
        $returnType = 'object';
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiSitesInfoGetAsync($token, $url)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiSitesInfoGetAsyncWithHttpInfo($token, $url)
    {
        $returnType = 'object';
        $request = $this->apiSitesInfoGetRequest($token, $url);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function apiSitesInfoGetRequest($token, $url)
    {
        // verify the required parameter 'token' is set
        if ($token === null || (is_array($token) && count($token) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $token when calling apiSitesInfoGet'
            );
        }
        // verify the required parameter 'url' is set
        if ($url === null || (is_array($url) && count($url) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $url when calling apiSitesInfoGet'
            );
        }
