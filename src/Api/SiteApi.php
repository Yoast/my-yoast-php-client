...
class SiteApi
{
     ...
     */
    public function apiSitesBulkPost($body)
    {
        list($response) = $this->apiSitesBulkPostWithHttpInfo($body);
        return $response;
    }
     ...
     */
    public function apiSitesBulkPostWithHttpInfo($body)
    {
        $returnType = '\Yoast\MyYoastApiClient\Model\Site[]';
        $request = $this->apiSitesBulkPostRequest($body);
     ...
     */
    public function apiSitesBulkPostAsync($body)
    {
        return $this->apiSitesBulkPostAsyncWithHttpInfo($body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiSitesBulkPostAsyncWithHttpInfo($body)
    {
        $returnType = '\Yoast\MyYoastApiClient\Model\Site[]';
        $request = $this->apiSitesBulkPostRequest($body);
     ...
     */
    protected function apiSitesBulkPostRequest($body)
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling apiSitesBulkPost'
            );
        }
     ...
     * Update one Site
     *
     * @param  \Yoast\MyYoastApiClient\Model\Site $body body (required)
     * @param  BigDecimal $id id (required)
     *
     * @throws \Yoast\MyYoastApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    {
        list($response) = $this->apiSitesIdPatchWithHttpInfo($body, $id);
        return $response;
    }
     ...
     * Update one Site
     *
     * @param  \Yoast\MyYoastApiClient\Model\Site $body (required)
     * @param  BigDecimal $id (required)
     *
     * @throws \Yoast\MyYoastApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * @return \Yoast\MyYoastApiClient\Model\Site
     */
    public function apiSitesPost($body)
    {
        list($response) = $this->apiSitesPostWithHttpInfo($body);
        return $response;
    }
     ...
     * @return array of \Yoast\MyYoastApiClient\Model\Site, HTTP status code, HTTP response headers (array of strings)
     */
    public function apiSitesPostWithHttpInfo($body)
    {
        $returnType = '\Yoast\MyYoastApiClient\Model\Site';
        $request = $this->apiSitesPostRequest($body);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiSitesPostAsync($body)
    {
        return $this->apiSitesPostAsyncWithHttpInfo($body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiSitesPostAsyncWithHttpInfo($body)
    {
        $returnType = '\Yoast\MyYoastApiClient\Model\Site';
        $request = $this->apiSitesPostRequest($body);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function apiSitesPostRequest($body)
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling apiSitesPost'
            );
        }
