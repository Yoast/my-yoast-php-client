...
class SiteApi
{
    ...
    {
        list($response) = $this->siteControllerDeleteOneWithHttpInfo($id);
        return $response;
    }
    ...
    {
        list($response) = $this->siteControllerGetManyPagedWithHttpInfo($filter);
        return $response;
    }
    ...
    /**
     * Operation siteControllerTransfer
     *
     * Transfer sites.
     *
     * @param  \Yoast\MyYoastApiClient\Model\TransferSiteDto $body body (required)
     ...
     * @return \Yoast\MyYoastApiClient\Model\Site[]
     */
    public function siteControllerTransfer($body)
    {
        list($response) = $this->siteControllerTransferWithHttpInfo($body);
        return $response;
    }

    /**
     * Operation siteControllerTransferWithHttpInfo
     *
     * Transfer sites.
     *
     * @param  \Yoast\MyYoastApiClient\Model\TransferSiteDto $body (required)
     ...
     * @return array of \Yoast\MyYoastApiClient\Model\Site[], HTTP status code, HTTP response headers (array of strings)
     */
    public function siteControllerTransferWithHttpInfo($body)
    {
        $returnType = '\Yoast\MyYoastApiClient\Model\Site[]';
        $request = $this->siteControllerTransferRequest($body);
    ...
    /**
     * Operation siteControllerTransferAsync
     *
     * Transfer sites.
     *
     * @param  \Yoast\MyYoastApiClient\Model\TransferSiteDto $body (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function siteControllerTransferAsync($body)
    {
        return $this->siteControllerTransferAsyncWithHttpInfo($body)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation siteControllerTransferAsyncWithHttpInfo
     *
     * Transfer sites.
     *
     * @param  \Yoast\MyYoastApiClient\Model\TransferSiteDto $body (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function siteControllerTransferAsyncWithHttpInfo($body)
    {
        $returnType = '\Yoast\MyYoastApiClient\Model\Site[]';
        $request = $this->siteControllerTransferRequest($body);
    ...
    /**
     * Create request for operation 'siteControllerTransfer'
     *
     * @param  \Yoast\MyYoastApiClient\Model\TransferSiteDto $body (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function siteControllerTransferRequest($body)
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling siteControllerTransfer'
            );
        }
    ...
    {
        list($response) = $this->siteControllerUpdateOneWithHttpInfo($body, $id);
        return $response;
    }
