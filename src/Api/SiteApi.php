...
class SiteApi
{
     ...
     * @return void
     */
    public function apiSitesIdUrlPatch($body, $id)
    {
        $this->apiSitesIdUrlPatchWithHttpInfo($body, $id);
    }

    /**
     * Operation apiSitesIdUrlPatchWithHttpInfo
     *
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function apiSitesIdUrlPatchWithHttpInfo($body, $id)
    {
        $returnType = '';
        $request = $this->apiSitesIdUrlPatchRequest($body, $id);
    ...
    /**
     * Operation apiSitesIdUrlPatchAsync
     *
     * 
     *
     * @param  \Yoast\MyYoastApiClient\Model\UpdateSiteUrlDto $body (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiSitesIdUrlPatchAsync($body, $id)
    {
        return $this->apiSitesIdUrlPatchAsyncWithHttpInfo($body, $id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation apiSitesIdUrlPatchAsyncWithHttpInfo
     *
     * 
     *
     * @param  \Yoast\MyYoastApiClient\Model\UpdateSiteUrlDto $body (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiSitesIdUrlPatchAsyncWithHttpInfo($body, $id)
    {
        $returnType = '';
        $request = $this->apiSitesIdUrlPatchRequest($body, $id);
    ...
    /**
     * Create request for operation 'apiSitesIdUrlPatch'
     *
     * @param  \Yoast\MyYoastApiClient\Model\UpdateSiteUrlDto $body (required)
     * @param  string $id (required)
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function apiSitesIdUrlPatchRequest($body, $id)
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling apiSitesIdUrlPatch'
            );
        }
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling apiSitesIdUrlPatch'
            );
        }
