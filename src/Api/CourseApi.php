...
class CourseApi
{
     ...
     * @return void
     */
    public function apiCoursesGet()
    {
        $this->apiCoursesGetWithHttpInfo();
    }
     ...
     */
    public function apiCoursesGetWithHttpInfo()
    {
        $returnType = '';
        $request = $this->apiCoursesGetRequest();
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiCoursesGetAsync()
    {
        return $this->apiCoursesGetAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiCoursesGetAsyncWithHttpInfo()
    {
        $returnType = '';
        $request = $this->apiCoursesGetRequest();
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function apiCoursesGetRequest()
    {
