...
class ProductGroupApi
{
     ...
     * @return void
     */
    public function apiProductGroupsGet()
    {
        $this->apiProductGroupsGetWithHttpInfo();
    }
     ...
     */
    public function apiProductGroupsGetWithHttpInfo()
    {
        $returnType = '';
        $request = $this->apiProductGroupsGetRequest();
     ...
     */
    public function apiProductGroupsGetAsync()
    {
        return $this->apiProductGroupsGetAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiProductGroupsGetAsyncWithHttpInfo()
    {
        $returnType = '';
        $request = $this->apiProductGroupsGetRequest();
     ...
     */
    protected function apiProductGroupsGetRequest()
    {
