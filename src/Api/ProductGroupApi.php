...
class ProductGroupApi
{
    ...
    /**
     * Operation apiProductGroupsUpdateDownloadPatch
     *
     * Update the download
     *
     ...
     * @return \Yoast\MyYoastApiClient\Model\ProductGroup
     */
    public function apiProductGroupsUpdateDownloadPatch($body)
    {
        list($response) = $this->apiProductGroupsUpdateDownloadPatchWithHttpInfo($body);
        return $response;
    }

    /**
     * Operation apiProductGroupsUpdateDownloadPatchWithHttpInfo
     *
     * Update the download
     *
     ...
     * @return array of \Yoast\MyYoastApiClient\Model\ProductGroup, HTTP status code, HTTP response headers (array of strings)
     */
    public function apiProductGroupsUpdateDownloadPatchWithHttpInfo($body)
    {
        $returnType = '\Yoast\MyYoastApiClient\Model\ProductGroup';
        $request = $this->apiProductGroupsUpdateDownloadPatchRequest($body);
    ...
    /**
     * Operation apiProductGroupsUpdateDownloadPatchAsync
     *
     * Update the download
     *
     * @param  \Yoast\MyYoastApiClient\Model\UpdateDownloadDto $body (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiProductGroupsUpdateDownloadPatchAsync($body)
    {
        return $this->apiProductGroupsUpdateDownloadPatchAsyncWithHttpInfo($body)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation apiProductGroupsUpdateDownloadPatchAsyncWithHttpInfo
     *
     * Update the download
     *
     * @param  \Yoast\MyYoastApiClient\Model\UpdateDownloadDto $body (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiProductGroupsUpdateDownloadPatchAsyncWithHttpInfo($body)
    {
        $returnType = '\Yoast\MyYoastApiClient\Model\ProductGroup';
        $request = $this->apiProductGroupsUpdateDownloadPatchRequest($body);
    ...
    /**
     * Create request for operation 'apiProductGroupsUpdateDownloadPatch'
     *
     * @param  \Yoast\MyYoastApiClient\Model\UpdateDownloadDto $body (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function apiProductGroupsUpdateDownloadPatchRequest($body)
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling apiProductGroupsUpdateDownloadPatch'
            );
        }
