...
class BlacklistApi
{
     ...
     *
     * @param  \Yoast\MyYoastApiClient\Model\CreateBlacklistSiteDto $createBlacklistSiteDto createBlacklistSiteDto (required)
     *
     * @throws \Yoast\MyYoastApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return string
     */
    public function apiBlacklistPost($createBlacklistSiteDto)
    {
        list($response) = $this->apiBlacklistPostWithHttpInfo($createBlacklistSiteDto);
        return $response;
    }
     ...
     * Creates a blacklisted site
     *
     * @param  \Yoast\MyYoastApiClient\Model\CreateBlacklistSiteDto $createBlacklistSiteDto (required)
     *
     * @throws \Yoast\MyYoastApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of string, HTTP status code, HTTP response headers (array of strings)
     */
    public function apiBlacklistPostWithHttpInfo($createBlacklistSiteDto)
    {
        $returnType = 'string';
        $request = $this->apiBlacklistPostRequest($createBlacklistSiteDto);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiBlacklistPostAsync($createBlacklistSiteDto)
    {
        return $this->apiBlacklistPostAsyncWithHttpInfo($createBlacklistSiteDto)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiBlacklistPostAsyncWithHttpInfo($createBlacklistSiteDto)
    {
        $returnType = 'string';
        $request = $this->apiBlacklistPostRequest($createBlacklistSiteDto);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function apiBlacklistPostRequest($createBlacklistSiteDto)
    {
        // verify the required parameter 'createBlacklistSiteDto' is set
        if ($createBlacklistSiteDto === null || (is_array($createBlacklistSiteDto) && count($createBlacklistSiteDto) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $createBlacklistSiteDto when calling apiBlacklistPost'
            );
        }
        ...
        // body params
        $_tempBody = null;
        if (isset($createBlacklistSiteDto)) {
            $_tempBody = $createBlacklistSiteDto;
        }
