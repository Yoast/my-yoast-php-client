...
class Order implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['vat_total'] === null) {
            $invalidProperties[] = "'vat_total' can't be null";
        }
        ...
        if ($this->container['source_shop_id'] === null) {
            $invalidProperties[] = "'source_shop_id' can't be null";
        }
     ...
     *
     * @param double $subtotal_amount subtotal_amount
     *
     * @return $this
     */
     ...
     * Sets vat_total
     *
     * @param double $vat_total vat_total
     *
     * @return $this
     */
     ...
     * Sets gl_number
     *
     * @param double $gl_number gl_number
     *
     * @return $this
     */
     ...
     * Sets source_shop_id
     *
     * @param double $source_shop_id source_shop_id
     *
     * @return $this
     */
     ...
     *
     * @param string $customer_first_name customer_first_name
     *
     * @return $this
     */
     ...
     *
     * @param string $customer_last_name customer_last_name
     *
     * @return $this
     */
     ...
     *
     * @param bool $exclude_from_revenue exclude_from_revenue
     *
     * @return $this
     */
