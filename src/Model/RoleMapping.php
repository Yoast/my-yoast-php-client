 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class RoleMapping implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RoleMapping';
     ...
     * Sets principal_type
     *
     * @param string $principal_type The principal type, such as USER, APPLICATION, ROLE, or user model name in case of multiple user models
     *
     * @return $this
     */
