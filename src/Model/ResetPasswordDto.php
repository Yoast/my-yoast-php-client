...
'key' => 'getKey'    ];
    ...
    {
        $this->container['userLogin'] = isset($data['userLogin']) ? $data['userLogin'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['userLogin'] === null) {
            $invalidProperties[] = "'userLogin' can't be null";
        }
        if ($this->container['password1'] === null) {
            $invalidProperties[] = "'password1' can't be null";
        }
        if ($this->container['password2'] === null) {
            $invalidProperties[] = "'password2' can't be null";
        }
