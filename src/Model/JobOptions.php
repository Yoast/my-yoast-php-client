 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class JobOptions implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'JobOptions';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['lifo'] === null) {
            $invalidProperties[] = "'lifo' can't be null";
        }
        ...
        if ($this->container['removeOnComplete'] === null) {
            $invalidProperties[] = "'removeOnComplete' can't be null";
        }
        if ($this->container['removeOnFail'] === null) {
            $invalidProperties[] = "'removeOnFail' can't be null";
        }
        if ($this->container['stackTraceLimit'] === null) {
            $invalidProperties[] = "'stackTraceLimit' can't be null";
        }
