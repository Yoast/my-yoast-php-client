...
# **apiRefundsBulkPost**
> \Yoast\MyYoastApiClient\Model\Refund[] apiRefundsBulkPost($body)
...
try {
    $result = $apiInstance->apiRefundsBulkPost($body);
    print_r($result);
} catch (Exception $e) {
...
# **apiRefundsIdPatch**
> \Yoast\MyYoastApiClient\Model\Refund apiRefundsIdPatch($body, $id)
...
$body = new \Yoast\MyYoastApiClient\Model\Refund(); // \Yoast\MyYoastApiClient\Model\Refund | 
$id = new \Yoast\MyYoastApiClient\Model\BigDecimal(); // BigDecimal | 

try {
    $result = $apiInstance->apiRefundsIdPatch($body, $id);
    print_r($result);
} catch (Exception $e) {
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\Yoast\MyYoastApiClient\Model\Refund**](../Model/Refund.md)|  |
 **id** | **BigDecimal**|  |
...
# **apiRefundsPost**
> \Yoast\MyYoastApiClient\Model\Refund apiRefundsPost($body)
...
try {
    $result = $apiInstance->apiRefundsPost($body);
    print_r($result);
} catch (Exception $e) {
