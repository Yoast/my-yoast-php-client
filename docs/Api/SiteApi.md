...
# **apiSitesBulkPost**
> \Yoast\MyYoastApiClient\Model\Site[] apiSitesBulkPost($bulkDto)
...
try {
    $result = $apiInstance->apiSitesBulkPost($bulkDto);
    print_r($result);
} catch (Exception $e) {
...
# **apiSitesPost**
> \Yoast\MyYoastApiClient\Model\Site apiSitesPost($site)
...
try {
    $result = $apiInstance->apiSitesPost($site);
    print_r($result);
} catch (Exception $e) {
