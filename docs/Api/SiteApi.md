...
[**apiSitesIdUrlPatch**](SiteApi.md#apisitesidurlpatch) | **PATCH** /api/Sites/{id}/url | 
...
try {
    $apiInstance->apiSitesIdUrlPatch($body, $id);
} catch (Exception $e) {
    echo 'Exception when calling SiteApi->apiSitesIdUrlPatch: ', $e->getMessage(), PHP_EOL;
}
?>
```
