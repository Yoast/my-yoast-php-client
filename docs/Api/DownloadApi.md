...
> \Yoast\MyYoastApiClient\Model\Download[] apiDownloadsBulkPost($bulkDto)
...
try {
    $result = $apiInstance->apiDownloadsBulkPost($bulkDto);
    print_r($result);
} catch (Exception $e) {
...
# **apiDownloadsIdPatch**
> \Yoast\MyYoastApiClient\Model\Download apiDownloadsIdPatch($download, $id)
...
$download = new \Yoast\MyYoastApiClient\Model\Download(); // \Yoast\MyYoastApiClient\Model\Download | 
$id = 8.14; // float | 

try {
    $result = $apiInstance->apiDownloadsIdPatch($download, $id);
    print_r($result);
} catch (Exception $e) {
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **download** | [**\Yoast\MyYoastApiClient\Model\Download**](../Model/Download.md)|  |
 **id** | **float**|  |
...
# **apiDownloadsPost**
> \Yoast\MyYoastApiClient\Model\Download apiDownloadsPost($download)
...
try {
    $result = $apiInstance->apiDownloadsPost($download);
    print_r($result);
} catch (Exception $e) {
