...
------------- | ------------- | -------------
[**apiDownloadsBulkPost**](DownloadApi.md#apidownloadsbulkpost) | **POST** /api/Downloads/bulk | Create many Download
...
[**apiDownloadsGet**](DownloadApi.md#apidownloadsget) | **GET** /api/Downloads | Retrieve many Download
[**apiDownloadsIdDelete**](DownloadApi.md#apidownloadsiddelete) | **DELETE** /api/Downloads/{id} | Delete one Download
[**apiDownloadsIdGet**](DownloadApi.md#apidownloadsidget) | **GET** /api/Downloads/{id} | Retrieve one Download
[**apiDownloadsIdPatch**](DownloadApi.md#apidownloadsidpatch) | **PATCH** /api/Downloads/{id} | Update one Download
[**apiDownloadsPost**](DownloadApi.md#apidownloadspost) | **POST** /api/Downloads | Create one Download

# **apiDownloadsBulkPost**
> \Yoast\MyYoastApiClient\Model\Download[] apiDownloadsBulkPost($body)
...
try {
    $result = $apiInstance->apiDownloadsBulkPost($body);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DownloadApi->apiDownloadsBulkPost: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
# **apiDownloadsGet**
> \Yoast\MyYoastApiClient\Model\Download[] apiDownloadsGet($fields, $filter, $or, $sort, $join, $perPage, $offset, $page, $cache)
...
$perPage = new \Yoast\MyYoastApiClient\Model\BigDecimal(); // BigDecimal | <h4>Receive <code>N</code> amount of entities.</h4><i>Syntax:</i> <strong>?per_page=number</strong><br/><i>Example:</i> <strong>?per_page=10</strong>
$offset = new \Yoast\MyYoastApiClient\Model\BigDecimal(); // BigDecimal | <h4>Offset <code>N</code> amount of entities.</h4><i>Syntax:</i> <strong>?offset=number</strong><br/><i>Example:</i> <strong>?offset=10</strong>
$page = new \Yoast\MyYoastApiClient\Model\BigDecimal(); // BigDecimal | <h4>Receive a portion of <code>limit</code> entities (alternative to <code>offset</code>). Will be applied if <code>limit</code> is set up.</h4><i>Syntax:</i> <strong>?page=number</strong><br/><i>Example:</i> <strong>?page=2</strong>
$cache = new \Yoast\MyYoastApiClient\Model\BigDecimal(); // BigDecimal | <h4>Reset cache (if was enabled) and receive entities from the DB.</h4><i>Usage:</i> <strong>?cache=0</strong>

try {
    $result = $apiInstance->apiDownloadsGet($fields, $filter, $or, $sort, $join, $perPage, $offset, $page, $cache);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DownloadApi->apiDownloadsGet: ', $e->getMessage(), PHP_EOL;
}
?>
```
 ...
 **perPage** | **BigDecimal**| &lt;h4&gt;Receive &lt;code&gt;N&lt;/code&gt; amount of entities.&lt;/h4&gt;&lt;i&gt;Syntax:&lt;/i&gt; &lt;strong&gt;?per_page&#x3D;number&lt;/strong&gt;&lt;br/&gt;&lt;i&gt;Example:&lt;/i&gt; &lt;strong&gt;?per_page&#x3D;10&lt;/strong&gt; | [optional]
 **offset** | **BigDecimal**| &lt;h4&gt;Offset &lt;code&gt;N&lt;/code&gt; amount of entities.&lt;/h4&gt;&lt;i&gt;Syntax:&lt;/i&gt; &lt;strong&gt;?offset&#x3D;number&lt;/strong&gt;&lt;br/&gt;&lt;i&gt;Example:&lt;/i&gt; &lt;strong&gt;?offset&#x3D;10&lt;/strong&gt; | [optional]
 **page** | **BigDecimal**| &lt;h4&gt;Receive a portion of &lt;code&gt;limit&lt;/code&gt; entities (alternative to &lt;code&gt;offset&lt;/code&gt;). Will be applied if &lt;code&gt;limit&lt;/code&gt; is set up.&lt;/h4&gt;&lt;i&gt;Syntax:&lt;/i&gt; &lt;strong&gt;?page&#x3D;number&lt;/strong&gt;&lt;br/&gt;&lt;i&gt;Example:&lt;/i&gt; &lt;strong&gt;?page&#x3D;2&lt;/strong&gt; | [optional]
 **cache** | **BigDecimal**| &lt;h4&gt;Reset cache (if was enabled) and receive entities from the DB.&lt;/h4&gt;&lt;i&gt;Usage:&lt;/i&gt; &lt;strong&gt;?cache&#x3D;0&lt;/strong&gt; | [optional]
...
# **apiDownloadsIdDelete**
> \Yoast\MyYoastApiClient\Model\Download apiDownloadsIdDelete($id)
...
$id = new \Yoast\MyYoastApiClient\Model\BigDecimal(); // BigDecimal | 

try {
    $result = $apiInstance->apiDownloadsIdDelete($id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DownloadApi->apiDownloadsIdDelete: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
# **apiDownloadsIdGet**
> \Yoast\MyYoastApiClient\Model\Download apiDownloadsIdGet($id, $fields, $join, $cache)
...
try {
    $result = $apiInstance->apiDownloadsIdGet($id, $fields, $join, $cache);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DownloadApi->apiDownloadsIdGet: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
# **apiDownloadsIdPatch**
> \Yoast\MyYoastApiClient\Model\Download apiDownloadsIdPatch($body, $id)
...
$body = new \Yoast\MyYoastApiClient\Model\Download(); // \Yoast\MyYoastApiClient\Model\Download | 
$id = new \Yoast\MyYoastApiClient\Model\BigDecimal(); // BigDecimal | 

try {
    $result = $apiInstance->apiDownloadsIdPatch($body, $id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DownloadApi->apiDownloadsIdPatch: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\Yoast\MyYoastApiClient\Model\Download**](../Model/Download.md)|  |
 **id** | **BigDecimal**|  |
...
# **apiDownloadsPost**
> \Yoast\MyYoastApiClient\Model\Download apiDownloadsPost($body)
...
try {
    $result = $apiInstance->apiDownloadsPost($body);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DownloadApi->apiDownloadsPost: ', $e->getMessage(), PHP_EOL;
}
?>
```
