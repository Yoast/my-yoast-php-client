...
# **downloadDownload**
> object downloadDownload($name, $version, $plugin_version, $site)
...
$plugin_version = "plugin_version_example"; // string | 
$site = "site_example"; // string | 

try {
    $result = $api_instance->downloadDownload($name, $version, $plugin_version, $site);
    print_r($result);
} catch (Exception $e) {
