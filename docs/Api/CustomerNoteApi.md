...
> \Yoast\MyYoastApiClient\Model\CustomerNote[] apiCustomerNotesBulkPost($body)
...
try {
    $result = $apiInstance->apiCustomerNotesBulkPost($body);
    print_r($result);
} catch (Exception $e) {
...
> \Yoast\MyYoastApiClient\Model\CustomerNote apiCustomerNotesIdPatch($body, $id)
...
$body = new \Yoast\MyYoastApiClient\Model\CustomerNote(); // \Yoast\MyYoastApiClient\Model\CustomerNote | 
$id = new \Yoast\MyYoastApiClient\Model\BigDecimal(); // BigDecimal | 

try {
    $result = $apiInstance->apiCustomerNotesIdPatch($body, $id);
    print_r($result);
} catch (Exception $e) {
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\Yoast\MyYoastApiClient\Model\CustomerNote**](../Model/CustomerNote.md)|  |
 **id** | **BigDecimal**|  |
...
> \Yoast\MyYoastApiClient\Model\CustomerNote apiCustomerNotesPost($body)
...
try {
    $result = $apiInstance->apiCustomerNotesPost($body);
    print_r($result);
} catch (Exception $e) {
