...
> \Yoast\MyYoastApiClient\Model\CourseEnrollment[] apiCourseEnrollmentsBulkPost($bulkDto)
...
try {
    $result = $apiInstance->apiCourseEnrollmentsBulkPost($bulkDto);
    print_r($result);
} catch (Exception $e) {
...
> \Yoast\MyYoastApiClient\Model\CourseEnrollment apiCourseEnrollmentsIdPatch($courseEnrollment, $id)
...
$courseEnrollment = new \Yoast\MyYoastApiClient\Model\CourseEnrollment(); // \Yoast\MyYoastApiClient\Model\CourseEnrollment | 
$id = "id_example"; // string | 

try {
    $result = $apiInstance->apiCourseEnrollmentsIdPatch($courseEnrollment, $id);
    print_r($result);
} catch (Exception $e) {
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **courseEnrollment** | [**\Yoast\MyYoastApiClient\Model\CourseEnrollment**](../Model/CourseEnrollment.md)|  |
 **id** | **string**|  |
...
> \Yoast\MyYoastApiClient\Model\CourseEnrollment apiCourseEnrollmentsPost($courseEnrollment)
...
try {
    $result = $apiInstance->apiCourseEnrollmentsPost($courseEnrollment);
    print_r($result);
} catch (Exception $e) {
