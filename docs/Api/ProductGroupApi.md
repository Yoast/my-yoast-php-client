...
> \Yoast\MyYoastApiClient\Model\ProductGroup[] apiProductGroupsBulkPost($body)
...
try {
    $result = $apiInstance->apiProductGroupsBulkPost($body);
    print_r($result);
} catch (Exception $e) {
...
> \Yoast\MyYoastApiClient\Model\ProductGroup apiProductGroupsIdPatch($body, $id)
...
$body = new \Yoast\MyYoastApiClient\Model\ProductGroup(); // \Yoast\MyYoastApiClient\Model\ProductGroup | 
$id = new \Yoast\MyYoastApiClient\Model\BigDecimal(); // BigDecimal | 

try {
    $result = $apiInstance->apiProductGroupsIdPatch($body, $id);
    print_r($result);
} catch (Exception $e) {
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\Yoast\MyYoastApiClient\Model\ProductGroup**](../Model/ProductGroup.md)|  |
 **id** | **BigDecimal**|  |
...
> \Yoast\MyYoastApiClient\Model\ProductGroup apiProductGroupsPost($body)
...
try {
    $result = $apiInstance->apiProductGroupsPost($body);
    print_r($result);
} catch (Exception $e) {
