...
# **apiOrdersBulkPost**
> \Yoast\MyYoastApiClient\Model\Order[] apiOrdersBulkPost($bulkDto)
...
try {
    $result = $apiInstance->apiOrdersBulkPost($bulkDto);
    print_r($result);
} catch (Exception $e) {
...
# **apiOrdersIdPatch**
> \Yoast\MyYoastApiClient\Model\Order apiOrdersIdPatch($order, $id)
...
$order = new \Yoast\MyYoastApiClient\Model\Order(); // \Yoast\MyYoastApiClient\Model\Order | 
$id = 8.14; // float | 

try {
    $result = $apiInstance->apiOrdersIdPatch($order, $id);
    print_r($result);
} catch (Exception $e) {
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **order** | [**\Yoast\MyYoastApiClient\Model\Order**](../Model/Order.md)|  |
 **id** | **float**|  |
...
# **apiOrdersPost**
> \Yoast\MyYoastApiClient\Model\Order apiOrdersPost($order)
...
try {
    $result = $apiInstance->apiOrdersPost($order);
    print_r($result);
} catch (Exception $e) {
