...
------------- | ------------- | -------------
[**apiOrdersBulkPost**](OrderApi.md#apiordersbulkpost) | **POST** /api/Orders/bulk | Create many Order
[**apiOrdersGet**](OrderApi.md#apiordersget) | **GET** /api/Orders | Retrieve many Order
[**apiOrdersIdDelete**](OrderApi.md#apiordersiddelete) | **DELETE** /api/Orders/{id} | Delete one Order
[**apiOrdersIdGet**](OrderApi.md#apiordersidget) | **GET** /api/Orders/{id} | Retrieve one Order
[**apiOrdersIdInvoiceGet**](OrderApi.md#apiordersidinvoiceget) | **GET** /api/Orders/{id}/invoice | Create invoice
[**apiOrdersIdPatch**](OrderApi.md#apiordersidpatch) | **PATCH** /api/Orders/{id} | Update one Order
...
[**apiOrdersPost**](OrderApi.md#apiorderspost) | **POST** /api/Orders | Create one Order

# **apiOrdersBulkPost**
> \Yoast\MyYoastApiClient\Model\Order[] apiOrdersBulkPost($body)
...
try {
    $result = $apiInstance->apiOrdersBulkPost($body);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling OrderApi->apiOrdersBulkPost: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
# **apiOrdersGet**
> \Yoast\MyYoastApiClient\Model\Order[] apiOrdersGet($fields, $filter, $or, $sort, $join, $perPage, $offset, $page, $cache)
...
try {
    $result = $apiInstance->apiOrdersGet($fields, $filter, $or, $sort, $join, $perPage, $offset, $page, $cache);
    print_r($result);
} catch (Exception $e) {
...
# **apiOrdersIdDelete**
> \Yoast\MyYoastApiClient\Model\Order apiOrdersIdDelete($id)
...
try {
    $result = $apiInstance->apiOrdersIdDelete($id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling OrderApi->apiOrdersIdDelete: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
# **apiOrdersIdGet**
> \Yoast\MyYoastApiClient\Model\Order apiOrdersIdGet($id, $fields, $join, $cache)
...
try {
    $result = $apiInstance->apiOrdersIdGet($id, $fields, $join, $cache);
    print_r($result);
} catch (Exception $e) {
...
# **apiOrdersIdPatch**
> \Yoast\MyYoastApiClient\Model\Order apiOrdersIdPatch($body, $id)
...
$body = new \Yoast\MyYoastApiClient\Model\Order(); // \Yoast\MyYoastApiClient\Model\Order | 
$id = new \Yoast\MyYoastApiClient\Model\BigDecimal(); // BigDecimal | 

try {
    $result = $apiInstance->apiOrdersIdPatch($body, $id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling OrderApi->apiOrdersIdPatch: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\Yoast\MyYoastApiClient\Model\Order**](../Model/Order.md)|  |
 **id** | **BigDecimal**|  |
...
# **apiOrdersPost**
> \Yoast\MyYoastApiClient\Model\Order apiOrdersPost($body)
...
try {
    $result = $apiInstance->apiOrdersPost($body);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling OrderApi->apiOrdersPost: ', $e->getMessage(), PHP_EOL;
}
?>
```
